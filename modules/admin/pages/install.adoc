...
. Укажите настройки {of-sm} в конфигурационном файле модуля по адресу `/usr/lib/docsvision/solutionmanager/appsettings.json` для Linux и `C:\Program Files\Docsvision\SolutionManager\appsettings.json` для Windows.
+
