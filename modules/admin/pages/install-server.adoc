...
----
{
  ...
  "SolutionManager": {
    "Extensions": [
      "DocsVision.SolutionManager.Logic.BaseExtension",
      "DocsVision.SolutionManager.WebService.BaseExtension"
    ],
    "TabOrders": [
      {
        "Id": "4EFE8B0C-7834-44AA-B1CE-2F841C27C27B",
        "Caption": "Kind Tab",
        "Order": 1
      }
    ],
