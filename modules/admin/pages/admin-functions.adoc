...
. Откройте конфигурационный файл `C:\Program Files (x86)\Docsvision\SolutionManager\appsettings.json`.
...
. Перейдите в ветку `{hklm-dv}WorkerService\Connections\SolutionManager`.
...
+
Путь к журналу и уровень протоколирования настраиваются в конфигурационном файле `C:\Program Files (x86)\Docsvision\SolutionManager\nlog.config`.
+
...
+
Пути к журналам и уровни протоколирования настраиваются в конфигурационном файле `C:\Program Files (x86)\Docsvision\WorkerService\SolutionManager\nlog.config`.
